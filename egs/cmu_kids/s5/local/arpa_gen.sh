...
# This script generates the arpa trigram language model, it takes the
# transcription file as input, which can be generated by trn_gen.sh in 
# the same directory.
#
# To run this script, you should have the CMU statistical language model
# toolkit. More info: http://www.speech.cs.cmu.edu/SLM/toolkit_documentation.html
