...
compile-train-graphs $dir/tree $dir/1.mdl  $lang/L.fst  \
  "ark:scripts/sym2int.pl --ignore-first-field $lang/words.txt < text.tmp |" \
  "ark:|gzip -c >$dir/graphs.fsts.gz"  2>$dir/compile_graphs.log
checkStatus compile-train-graphs
rm text.tmp
