...
# TODO DEL: langfst=data/lang_test_bg # <-- want the fst to go to the lang_test_bg for the dnn code  
mkdir -p $tmpdir
...
#TODO DEL: mkdir $langfst
# TODO DEL: mv $lang/L.fst $langfst/L.fst # <-- this is for the dnn script
...
#TODO del: mv $lang/G.fst $langfst/G.fst # <-- this is for the dnn script
...
######################### NOTE: NOTHING RUNS AFTER THE EXIT ABOVE #############################
