...
tidigits=/workspace/zhorai-workspace/datasets/tidigits_tr-c_te-c/data

# The following command prepares the data/{train,dev,test} directories.
local/tr-c_te-c_tidigits_data_prep.sh $tidigits || exit 1;
## TODO: removed this because it was causing errors. Making my own data/local/dict/silence_phones.txt, data/local/dict/lexicon.txt, etc
