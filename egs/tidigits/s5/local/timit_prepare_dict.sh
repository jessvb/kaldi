...
## TODO: let's just quit extra_q because it doesn't like us ...
#cat $dir/silence_phones.txt| awk '{printf("%s ", $1);} END{printf "\n";}' >> $dir/extra_questions.txt || exit 1;
## TODO: this is erroring out :( nonsilence_phones -- bad phone
#cat $dir/nonsilence_phones.txt | perl -e 'while(<>){ foreach $p (split(" ", $_)) {
#  $p =~ m:^([^\d]+)(\d*)$: || die "Bad phone $_"; $q{$2} .= "$p "; } } foreach $l (values %q) {print "$l\n";}' \
# >> $dir/extra_questions.txt || exit 1;


## TODO: I'M GETTING A BUG WITH THE LEXICON NOT KNOWING sil, SO I'M ADDING IT HERE
#echo "sil     sil" >> $dir/extra_questions.txt
## and here for the lexiconp.txt error:
#echo "sil     1.0     sil" >> $dir/extra_questionsp.txt
