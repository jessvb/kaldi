...
echo "DON'T USE THIS TIMIT PREP DATA FILE FOR TIDIGITS. USE A TIDIGITS SPECIFIC ONE."
exit 1;
if [ $# -ne 1 ]; then
...
## CHANGE FOR TIDIGITS: all the files are used for tidigits, so we just grab them all
#if $uppercased; then
